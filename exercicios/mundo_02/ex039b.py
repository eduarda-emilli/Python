...
if sexo == 1:
    if idade < 18:
        ...
        print(f'Você não tem idade para se alistar, mas não precisa se preocupar, o alistamento militar não é obrigatório para mulheres.')
    elif idade == 18:
    ...
    if idade < 18:
        alistamento = 18 - idade
        print(f'Você ainda não tem idade para se alistar. Faltam {alistamento} anos para o seu alistamento!')
    elif idade == 18:
